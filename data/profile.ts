export const profile = {
  ...
  summary:
    "歩行やスポーツ動作を動画から定量化し、人の動きを客観的に理解するための研究と開発に取り組んでいます。",
  contact: {
...
export const heroStats = [
  { label: "Research Field", value: "Computer Vision" },
  { label: "Focus", value: "Human Motion" },
  { label: "Interest", value: "AI / Data Analysis" },
];
...
export const projects = [
  ...
  {
    title: "GitHubリンク用カード",
    type: "Research / Development Archive",
    description:
